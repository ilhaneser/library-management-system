...
const SearchBooks = () => {
  ...
  const fetchGenres = async () => {
    try {
      ...
      // For now, we'll just use some common genres
      setGenres([
      ...
      <div className="card shadow-sm mb-4">
        <div className="card-body">
          ...
          <div className="accordion" id="filtersAccordion">
            <div className="card">
              <div className="card-header bg-light" id="headingFilters">
                <h2 className="mb-0">
                  <button className="btn btn-link btn-block text-left text-dark" type="button" data-toggle="collapse" data-target="#collapseFilters" aria-expanded="true" aria-controls="collapseFilters">
                    <i className="fas fa-filter mr-2"></i> Advanced Filters
                  </button>
                </h2>
              </div>

              <div id="collapseFilters" className="collapse" aria-labelledby="headingFilters" data-parent="#filtersAccordion">
                <div className="card-body">
                  <div className="row">
                  ...
                  <div className="mt-3">
                    <button onClick={onSearch} className="btn btn-primary mr-2">
                      Apply Filters
                    </button>
